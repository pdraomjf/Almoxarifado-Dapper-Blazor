...
namespace AlmoxarifadoAPI.Controllers
{
    ...
    public class AlmoxarifadoController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<Almoxarifado>>> GetAsync()
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Almoxarifado>> PostAsync(Almoxarifado obj)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAsync(string id, Almoxarifado obj)
        {
            if (id != obj.Id)
                return BadRequest();
